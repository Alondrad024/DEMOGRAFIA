...
tamaulipas <- read.csv(file.choose())


tamaulipas2 <- tamaulipas %>%
as_tibble () %>%
...
table (tamaulipas2$SEXO)

table (tamaulipas2$escolaridad)

table (tamaulipas2$gpoeda)

table (tamaulipas2$SITUA_CONYUGAL)

table (tamaulipas2$conyu)


## BASE VIVIENDA

tamaulipasvivi <- read.csv(file.choose())

tamaulipasvivienda <- tamaulipasvivi %>%
as_tibble () %>%
...
table (tamaulipasvivienda$clase)

table (tamaulipasvivienda$techo)

table (tamaulipasvivienda$bienes)

table (tamaulipasvivienda$sincomer)

table (tamaulipasvivienda$tenencia)
